                            ...
                            <tbody>
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="">
                                                ...
                                                <img src="{{ asset($pdt -> model-> image) }}" height="50px"
                                                    width="90px">
                                            </a>
                                            <div class="cart-product-content">
                                                <p class="cart-author">{{ $pdt -> name }}</p>

                                                <h5 class="cart-product-title">{{ Auth::user() -> name}}</h5>
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{ route('cart.reduce' , ['id' => $pdt -> rowId , 'qty' => $pdt -> qty]) }}"
                                                class="quantity-minus">-</a>
                                            <input value="{{ $pdt -> qty }}" title="Qty"
                                                class="email input-text qty text" type="text" placeholder="1" readonly>
                                            <a href="{{ route('cart.increment' , ['id' => $pdt -> rowId , 'qty' => $pdt -> qty]) }}"
